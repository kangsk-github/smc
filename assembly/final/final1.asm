...
ExceptionPtr__hla_	equ	fs:0
		...
		include	'final1.extpub.inc'




		section	'.data' data readable writeable align 16
		include	'final1.data.inc'

		dd	0	;dummy to keep linker happy
		section	'.bss' readable writeable align 16
		include	'final1.bss.inc'

		rb	4	;dummy to keep linker happy
		section	'.text' code readable executable align 16
		include	'final1.consts.inc'

		include	'final1.ro.inc'
...
L823_getSmallest__hla_:
		pop	dword ptr [L824_dReturnAddress__hla_+0]	;/* dReturnAddress */
		pop	dword ptr [ebp+8]	;/* stringData */
		push	dword ptr [L824_dReturnAddress__hla_+0]	;/* dReturnAddress */
		push	ebx
		push	ecx
		mov	ah, 0
		mov	ebx, dword ptr [ebp+8]	;/* stringData */
		mov	al, [ebx+0]	;/* [ebx] */
		mov	ecx, dword ptr [ebp+8]	;/* stringData */

L825_compareStart__hla_:
		inc	ecx
		cmp	[ecx+0], ah	;/* [ecx] */
		je	L826_endCompare__hla_
		cmp	al, [ecx+0]	;/* [ecx] */
		jle	L827_leftOneSmaller__hla_
		jmp	L828_rightOneSmaller__hla_

L827_leftOneSmaller__hla_:
		jmp	L825_compareStart__hla_

L828_rightOneSmaller__hla_:
		mov	al, [ecx+0]	;/* [ecx] */
		jmp	L825_compareStart__hla_

L826_endCompare__hla_:
		pop	ecx
		pop	ebx
		ret
xL823_getSmallest__hla___hla_:
;L823_getSmallest__hla_ endp
